                              ...
                              <div class="breadcrumbs__items">
                                  <div class="breadcrumbs__wrap">
                                      <div class="breadcrumbs__item">
                                          <Link to="/" class="breadcrumbs__item-link">Home</Link> <span>/</span> <Link to="/fleets" class="breadcrumbs__item-link">Fleet</Link> <span>/</span> <Link to="/details" class="breadcrumbs__item-link">Hyundai i30</Link>
                                      </div>
                                  </div>
                              </div>
                          </div>
                  ...
                  <div class="row">
                      <div class="col-xs-12">
                          <div class="model-details-box">
                              <Link to="/fleets" class="back-btn">Back to Vehicle Fleet</Link>
                              <div class="model-details-box__inner">
                                  <div class="model-details-box__info">
                                      ...
                                      <Link to="#" class="btn">CHECK RATES</Link>
                                  </div>
                                  ...
                                  <div class="inner-form__elements">
                                      <div class="inner-half">
                                          ...
                                          <div class="text-element stop-location">
                                              <Link to="#" class="add" id="add-stop"><i class="icon-plus-black-symbol"></i> <span>Click here to add a stop</span></Link>
                                              <Link to="#" class="link-right">airports</Link>
                                          </div>
