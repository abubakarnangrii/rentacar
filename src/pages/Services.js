                      ...
                      <div className="swiper-wrapper">
                          <div className="swiper-slide odd-line">
                              <div className="service-block">
                                  <figure className="thumbnail"><span><Link to="/services-post"><img src="assets/images/service_img_1.jpg" alt="" /></Link></span></figure>
                          ...
                          <div className="swiper-slide even-line">
                              <div className="service-block">
                                  <figure className="thumbnail"><span><Link to="/services-post"><img src="assets/images/service_img_2.jpg" alt="" /></Link></span></figure>
                                  <div className="service-block__content">
                          ...
                          <div className="swiper-slide odd-line">
                              <div className="service-block">
                                  <figure className="thumbnail"><span><Link to="/services-post"><img src="assets/images/service_img_3.jpg" alt="" /></Link></span></figure>
                                  <div className="service-block__content">
                          ...
                          <div className="swiper-slide odd-line">
                              <div className="service-block">
                                  <figure className="thumbnail"><span><Link to="/services-post"><img src="assets/images/service_img_4.jpg" alt="" /></Link></span></figure>
                                  <div className="service-block__content">
                                      <h3>Private Tours</h3>
                          ...
                          <div className="swiper-slide even-line">
                              <div className="service-block">
                                  <figure className="thumbnail"><span><Link to="/services-post"><img src="assets/images/service_img_5.jpg" alt="" /></Link></span></figure>
                                  <div className="service-block__content">
                                      <h3>To My Door</h3>
                          ...
                          <div className="swiper-slide odd-line">
                              <div className="service-block">
                                  <figure className="thumbnail"><span><Link to="/services-post"><img src="assets/images/service_img_6.jpg" alt="" /></Link></span></figure>
                                  <div className="service-block__content">
                                      <h3>Private Tours</h3>
                              ...
                              <div className="swiper-slide">
                                  <div className="post-column">
                                      ...
                                      <div className="post-column__content">
                                          ...
                                          <span className="text-link">Budget Prices for Long Term Rentals</span>
                                          <Link to="/" className="btn btn__marker"><i className="icon-arrows"></i></Link>
                                      </div>
                                  </div>
                              </div>
                              <div className="swiper-slide">
                                  <div className="post-column">
                                      ...
                                      <div className="post-column__content">
                                          ...
                                          <span className="text-link">Search Prices and Special Offers</span>
                                          <Link to="/" className="btn btn__marker"><i className="icon-arrows"></i></Link>
                                      </div>
